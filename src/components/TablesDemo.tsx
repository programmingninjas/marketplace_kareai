...
//           <Table className="border border-gray-200 shadow-lg shadow-gray-200">
...
const TableDemo: React.FC<props> = ({url}) => {
  ...
  useEffect(() => {
    axios
      .get("http://98.70.9.194:8069/api/sectors/technology")
      .then((response) => {
    ...
    <div className="w-full h-full overflow-y-auto">
      <div className="bg-white m-5">
        <div className="parent_div w-full py-5  h-[500px] bg- flex">
          <div className="p-5 w-1/2 bg--200 h-full overflow-y-auto border rounded-xl border-gray-200 m-2">
            <h1 className="text-2xl mb-3 font-semibold">Financial Summary</h1>
            <Table className="border--200 shadow- shadow-gray-200">
              ...
              <TableBody>
                {financialSummary.map((item, index) => (
                  <TableRow key={index}>
                    <TableCell className="font-medium border">{item.Industry}</TableCell>

                    <TableCell className="border">{item.RevenueGrowth}</TableCell>
                    <TableCell className="border">{item.NetIncomeGrowth}</TableCell>
                    <TableCell className="border">{item.NetMargin}</TableCell>
                    <TableCell className="border">{item.StockGrowth}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <div className="p-5 w-1/2 h-full bg--100 border rounded-xl border-gray-200 m-2">
            <h1 className="text-2xl mb-3 font-semibold">Management Effectiveness</h1>
            <Table className="border--200 shadow- shadow-gray-200">
              <TableCaption></TableCaption>
              <TableHeader>
              ...
              <TableBody>
                {Object.keys(managementEffectiveness).map((key, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="border">{managementEffectiveness[key]["2 Q 2024"]}</TableCell>
                    <TableCell className="border">{managementEffectiveness[key]["1 Q 2024"]}</TableCell>
                    <TableCell className="border">{managementEffectiveness[key]["4 Q 2023"]}</TableCell>
                    <TableCell className="border">{managementEffectiveness[key]["3 Q 2023"]}</TableCell>
                    <TableCell className="border">{managementEffectiveness[key]["2 Q 2023"]}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <Table className="border border-gray-200 shadow-lg shadow-gray-200">
            ...
            <TableBody>
              {valuationRatios.map((item, index) => (
                <TableRow key={index}>
                  <TableCell className="font-medium border">{item.Industry}</TableCell>
                  <TableCell className="border">{item.Quarters}</TableCell>
                  <TableCell className="border">{item["Cash Flow Margin"]}</TableCell>
                  <TableCell className="border">{item["P/E Ratio"]}</TableCell>
                  <TableCell className="border">{item["Debt to Equity Ratio"]}</TableCell>
                  <TableCell className="border">{item["Quick Ratio"]}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
        ...
        <div className="p-5 border-2 border-gray-200 m-5">
          ...
          <Table className="border border-gray-200 shadow-lg shadow-gray-200">
            ...
            <TableHeader>
              <TableRow>
                <TableHead className="w-[150px] border">Category</TableHead>
            ...
            <TableBody>
              {recentNews.map((item, index) => (
                <TableRow key={index}>
                  <TableCell className="font-medium border">{item.category}</TableCell>
